...
public class EditarCategoriaController implements Initializable {
    ...
    private void guardarCategoria(){
        categoria.setImporte(Integer.parseInt(txtImporte.getText()));
        
        catser.save(categoria);
    ...
    public void initData(Categoria cat){
        this.categoria=cat;
        lblTitulo.setText("Editar categoria ID: "+categoria.getIdCategoria());
        txtNombre.setText(categoria.getNombre());
        txtNombre.setDisable(true);
        txtImporte.setText(Integer.toString(categoria.getImporte()));
    }
