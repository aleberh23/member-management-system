...
@Component
public class EditarDeudaController implements Initializable {
    private Deuda deuda;
    ...
    public void initData(Deuda deudaedit){
        this.deuda = deudaedit;
        this.socio = deuda.getSocioDeudor();
        ...
        //setear datos de deuda
        txtImporte.setText(Integer.toString(deuda.getImporte()));
        fechaGeneracion.setValue(deuda.getFechaGeneracion());
        cmbxAnio.setValue(deuda.getAnio());
        CuotaDTO cuota = new CuotaDTO(deuda.getCuota(), Month.of(deuda.getCuota()).name());
        cmbxCuota.setValue(cuota);
    }
