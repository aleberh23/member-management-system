...
@Component
public class CargaCobradorController implements Initializable{
    ...
    private void guardarCobrador(){
        ...
        cob.setNombre(txtNombre.getText());
        cob.setNroTelefono(Long.parseLong(txtNroTelefono.getText()));
        
        cobradorser.saveCobrador(cob);
        //obtener el stage
        Stage stage = (Stage) anchorPane.getScene().getWindow();
        // Cierra el Stage
        stage.close();
